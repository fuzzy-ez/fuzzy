...
function renderTemplates(componentFolder, componentFolderName, renderData) {
    return __awaiter(this, void 0, void 0, function () {
        var kebabCaseName, bigCamelizeName, camelizeName, style, codeSfc, codeTs, codeIndex, codeProps, codeTest;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    kebabCaseName = renderData.kebabCaseName, bigCamelizeName = renderData.bigCamelizeName, camelizeName = renderData.camelizeName, style = renderData.style;
                    ...
                    codeProps = "// import { definePropType } from '@fuzzy/utils'\nimport type { ExtractPropTypes } from 'vue'\n\nexport const ".concat(camelizeName, "Props = {}\n\nexport type ").concat(bigCamelizeName, "Props = ExtractPropTypes<typeof ").concat(camelizeName, "Props>\n  ");
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            (0, fs_extra_1.ensureFile)("".concat(componentFolder, "/src/props.ts")),
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            (0, fs_extra_1.writeFile)((0, path_1.resolve)("".concat(componentFolder, "/src"), 'props.ts'), codeProps),
